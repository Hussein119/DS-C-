...
UnsortedLinkedType::UnsortedLinkedType()  // Class constructor
{
	length = 0;
	listData = NULL;
}
bool UnsortedLinkedType::IsFull() const
...
int UnsortedLinkedType::GetLength() const
// Post: Number of items in the list is returned.
{
	return length;
}

void UnsortedLinkedType::MakeEmpty()
...
void UnsortedLinkedType::ResetList()
// Post: Current position has been initialized.
{
	currentPos = NULL;
}

ItemType UnsortedLinkedType::GetNextItem()
